        ...
        addQuestionButton.setOnClickListener(view -> {
            if (!MainActivity.loggedInUser.equals("User")) {
                if (!MainActivity.loggedInUser.equals(quiz.getUserid())) {
                    ...
                    rightAnswer.setFilters(new InputFilter[]{new InputFilter.LengthFilter(30)});
                    answer2.setFilters(new InputFilter[]{new InputFilter.LengthFilter(30)});
                    answer3.setFilters(new InputFilter[]{new InputFilter.LengthFilter(30)});
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
...

                {
                    ...
                    URL url = new URL("http://15.188.88.253:8080/api/quizapp/createquestion?question=" + question.getQuestion() + "&rightAnswer=" + question.getRightAnswer() + "&answer2=" + question.getAnswer2() + "&answer3=" + question.getAnswer3() + "&quiz=" + quiz1);
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
...

                {
                    ...
                    URL url = new URL("http://15.188.88.253:8080/api/quizapp/deletequestion?question=" + question + "&quiz=" + quiz.getName());
                    c = (HttpURLConnection) url.openConnection();
                    c.setUseCaches(true);
